                ...
                <div class="div3">
                    ...
                    <div class="delete-usuario">
                        ...
                        <?php if(isset($_POST['delete'])){ ?>
                            <?php 
                                delete($connect, "hamburguer", $_POST['id']);
                            ?>
                        <?php } elseif (isset($_POST['nao_deletar'])) { ?>
                            <?php header("location: hamburguer.php"); ?>
                        <?php } ?>
                    </div>
                                ...
                                <?php foreach ($hamburguers as $hamburguer) : ?>
                                    <tr class="tabela-body-coluna">
                                        <?php if (!empty($hamburguer['foto_hamburguer'])) { ?>
                                            <td class="text-center"><img width="80px" src="model/uploads/<?php echo $hamburguer['foto_hamburguer']; ?>" alt=""></td>
                                        <?php } else { ?>
                                            <td class="text-center"><img width="80px" src="css/img/avtar.png" alt=""></td>
                                        <?php } ?>
                                        <td class="align-middle text-center"><?php echo $hamburguer['id'] ?></td>
